...
//			retCitizen.setCrimerecord();
		...
		System.out.println("Let's do single threaded calculations...");
		
		long startTime = System.currentTimeMillis();
		Citizen result1 = list.findMax(list, new CitizenBirthDateComparator());
		System.out.println(result1);
		result1 = list.findMin(list, new CitizenNameComparator());
		System.out.println(result1);
		long elapsedTime1 = System.currentTimeMillis() - startTime;
        
		System.out.println("Let's do multithreaded calculations...");
		...
		System.out.println("Single-Threaded calculations took: " + elapsedTime1 + " ms.");
		System.out.println("Multi-Threaded calculations took: " + elapsedTime2 + " ms.");
		System.out.printf("Multi-Threaded is faster in %,.2f times.%s", (float)elapsedTime1/elapsedTime2, System.lineSeparator());
		sc.close();
	}
